"""SQL DDL, DML, and migration statements for the imaging-hub database schema."""
...
INSERT_QUERY_DICOM_META = """
    INSERT INTO dicom_insert (
        ...
        modality_type, assoc_id, project
...
INSERT_QUERY_DICOM_ASS = """
    INSERT INTO associations (
        uuid, ae_title, ip_address, port, timestamp, called_ae_title
    ) VALUES (%s, %s, %s, %s, %s, %s)
"""
...
MIGRATE_ADD_PROJECT_DICOM_INSERT = """
ALTER TABLE dicom_insert ADD COLUMN IF NOT EXISTS project TEXT;
"""

MIGRATE_ADD_PROJECT_PACS_ARCHIVE = """
ALTER TABLE pacs_archive ADD COLUMN IF NOT EXISTS project TEXT;
"""

MIGRATE_ADD_CALLED_AET_ASSOCIATIONS = """
ALTER TABLE associations ADD COLUMN IF NOT EXISTS called_ae_title TEXT;
"""
